const Contact = () => {
  return (
    <div className="max-w-full relative min-h-screen flex items-center justify-center mx-auto text-gray-800 p-10 rounded-xl shadow-lg">
        ...
        <div className="flex justify-center gap-20">
          <div className="flex flex-row justify-center">
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-dark-teal-green hover:bg-bright-leaf-green text-white py-3 rounded-md transition duration-300"
              >
                Send Message
              </button>
            </form>
